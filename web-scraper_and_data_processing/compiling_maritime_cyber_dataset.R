...
maritime_news_and_cyber_incidents_datasets_combined = data.frame("Date" = append(as.character(maritime_disputes_FT$truncated_date),
...
save(maritime_news_and_cyber_incidents_datasets_combined, file = "maritime_news_and_cyber_incidents_datasets_combined.RData")